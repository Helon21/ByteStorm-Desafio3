...
public class PropostaConstantes {
    ...
    public final static Proposta PROPOSTA1 = new Proposta(1L, 1L, "Propor melhoria na saúde", "Devemos focar na saúde pois é uma área que necessita de maiores cuidados", true);

    public final static Proposta PROPOSTA2 = new Proposta(2L, 1L, "Propor melhoria na educação", "Devemos focar na educação pois os jovens são o futuro da humanidade, e precisamos passar o conhecimento adiante para que não seja perdido", true);

    public final static Proposta PROPOSTA_INVALIDA = new Proposta(3L, null, null, null, null);

    public final static Proposta PROPOSTA_ATIVA = new Proposta(1L, 1L, "Titulo da proposta", "Descrição da proposta", true);

    public final static Proposta PROPOSTA_INATIVA = new Proposta(1L, 1L, "Titulo da proposta", "Descrição da proposta", false);
